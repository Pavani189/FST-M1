...
UPDATE salesman SET salesman_name='Pierre' WHERE salesman_name='Lauson Hen';
...
elect * from orders where purchase_amount between 1000 and 2000;
...
WHERE 1<(SELECT COUNT(*) FROM orders b WHERE a.customer_id = b.salesman_id) 
...
SELECT salesman_id,salesman_name FROM salesman a 
WHERE 1<(SELECT COUNT(*) FROM orders b WHERE c.customer_id = b.salesman_id) 
ORDER BY customer_name;

SELECT salesman_id,salesman_name FROM salesman c 
WHERE 1<(SELECT COUNT(*) FROM orders b WHERE c.customer_id = b.salesman_id) 
ORDER BY customer_name;

SELECT salesman_id,salesman_name FROM salesman c 
WHERE 1<(SELECT COUNT(*) FROM orders b WHERE b.salesman_id =c.customer_id ) 
ORDER BY customer_name;
